...
void init_object(Object* object, int x, int z, float y)
{
	object->position.x = x;
	object->position.y = y;
	object->position.z = z;
...
void init_entities(World* world) {
	...
	// house2
	load_model("models//house2.obj", &world->house2.model);
	world->house2.texture = load_texture("textures//ht1.png");
	init_object(&world->house2, 20, -5, 0.15);

	//house3 - nem mozgatható ház
    load_model("models//house3.obj", &world->skyscraper.model);
    world->skyscraper.texture = load_texture("textures//ht3.png");
    init_object(&world->skyscraper, 2, -7, 0.06);
	
	//border buildings
		load_model("models//border_buildings.obj", &world->border_b1.model);
		world->border_b1.texture = load_texture("textures//border.png");
		init_object(&world->border_b1, 380, 180, -4.85);
		
		load_model("models//border_buildings.obj", &world->border_b2.model);
		world->border_b2.texture = load_texture("textures//border.png");
		init_object(&world->border_b2, -140, -400, -4.8);
		

	// City
	world->city.ground = load_texture("textures/skybox//bottom2.jpg");
	world->city.back = load_texture("textures/skybox//back.jpg");
	world->city.front = load_texture("textures/skybox//front.jpg");
	world->city.left = load_texture("textures/skybox//left.jpg");
	world->city.right = load_texture("textures/skybox//right.jpg");
	world->city.top = load_texture("textures/skybox//top.jpg");

	// Help
	world->helpPanel = load_texture("textures//help.png");
}
